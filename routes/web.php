...
// Route::get('/receive', 
//     ['as'=>'receive',
//     'uses'=>'UserController@receive'
//     ]);
// Route::get('/receive', 
//     ['as'=>'receive',
//     'uses'=>'TransactionController@receive'
//     ]);
//     Route::get('/receive', function  () {
//     return view('receive');
// });
Route::resource('receive','TestController');
Route::get('Withdraw','TestController@bank');

//Route::get('/receive','UserController@receive');
