            ...
            <nav class="navbar navbar-inverse navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="container">
                    ...
                    <div class="navbar-header">
                        <a class="navbar-brand" href="{{ route('home') }}"><i class="fa fa-cash"></i> <strong>e-</strong><strong></strong></a>
                    </div>
                    <!-- end:navbar-header -->
                    <ul class="nav navbar-nav navbar-left top-menu">
                        <!-- start dropdown 3 -->
                        <li id="header_notification_bar" class="dropdown">
                            <a data-toggle="dropdown" class="dropdown-toggle" href="client\img\Bitcoinwallet.png">
                            ...
                            <ul class="nav navbar-nav">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        <li>
                                            <a href="{{ url('receive') }}">
                                            <i class="fa fa-money"></i>receive</a></li>
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        <li><a href="{{ route('Withdraw') }}"><i class="fa fa-table"></i>Withdraw to Bank</a></li>
                                    </ul>
                                </li>
                                <li class="dropdown">
                                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <span class="sosmed-footer">
                                <a href="https://www.facebook.com/Decentralized-International-Payments-100934842155407"><i class="fa fa-facebook" data-toggle="tooltip" data-placement="top" title="Facebook"></i></a>
                                <a href="https://twitter.com/DecentralizedI5"><i class="fa fa-twitter" data-toggle="tooltip" data-placement="top" title="Twitter"></i></a>
                            
                            </span>
                            &copy; 2021 <strong>e</strong>-Wallet<strong>.</strong></p>
                        </div>
                        <div class="col-sm-6">
